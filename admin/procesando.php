...
//var agree = confirm("¿Realmente desea eliminarlo?");
if (confirm("¿Realmente desea Aprobar esta Venta?"))
    window.location.href = url;
else
    return false ;
}
        ...
        if (isset($_GET['eliminar'])) { 
         ...
         if (isset($_GET['aprobar'])) { 
                ...
                echo '<div class="alert alert-success alert-dismissable">
                        <i class="fa fa-check"></i>
                           <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <b>Bien!</b> Se Aprobo Correctamente... </div>';
                    }
        }
                                             ...
                                             <td width="25%" class="hidden-print noprin">
                                                <center>
                                                  ...
                                                  <?php
                                                   ...
                                                   href="?admin=procesando&aprovar&codigo=<?php echo $id ?>"   title="Pago revisado aprobar"   onclick='if(confirmDela() == false){return false;}' ><i class='fa fa-check-square-o'></i></a>
                                                  <?php 
                                                   }
                                                    ?>
