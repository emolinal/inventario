                    ...
                    <div class="col-md-3 col-sm-6 no-space">
                        ...
                        <div class="widget-subscribe">
                            ...
                            <h2 class="widget-subscribe-title widget-title-color-gray-dark text-uppercase">Generar 
                                <br/>Factura</h2>
                            <p class="widget-subscribe-subtitle widget-title-color-dark-light">Ingresa al menu Pedidos y carga al carrito para generar la factura                                <a class="widget-subscribe-subtitle-zipi2" href="?mod=services">Realizar Pedido</a>
                            </p>
                        </div>
                        <!-- END WIDGET SUBSCRIBE -->
                    </div>
